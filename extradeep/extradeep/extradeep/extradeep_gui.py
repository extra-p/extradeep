...
from extradeep.util.exceptions import RecoverableError, CancelProcessError
...
def parse_arguments(args=None):
    parser = argparse.ArgumentParser(description=extradeep.__description__)
    ...
    parser.add_argument("--version", action="version", version=extradeep.__title__ + " " + extradeep.__version__)
    ...
    if sys.platform.startswith('darwin'):
        try:
            ...
            if bundle:
                ...
                if app_info:
                    app_info['CFBundleName'] = extradeep.__title__
