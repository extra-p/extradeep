...
from extradeep.entities.functions import ConstantFunction
from extradeep.entities.functions import MultiParameterFunction
from extradeep.entities.hypotheses import ConstantHypothesis
from extradeep.entities.hypotheses import MultiParameterHypothesis
from extradeep.entities.measurement import Measurement
from extradeep.entities.model import Model
from extradeep.entities.terms import MultiParameterTerm
from extradeep.modelers import single_parameter
from extradeep.modelers.abstract_modeler import MultiParameterModeler as AbstractMultiParameterModeler
...
class MultiParameterModeler(AbstractMultiParameterModeler, SingularModeler):
    ...
    def find_best_measurement_points(self, measurements: Sequence[Measurement]):
        ...
        def make_measurement(c, ms: Sequence[Measurement]):
            ...
            measurement = Measurement(Coordinate(c), ms[0].callpath, ms[0].metric, ms[0].analysistype, None)
