...
from extradeep.entities.terms import CompoundTerm, MultiParameterTerm, CompoundTermSchema, MultiParameterTermSchema
from extradeep.util.serialization_schema import BaseSchema, NumberField
