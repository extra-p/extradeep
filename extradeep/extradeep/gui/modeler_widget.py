...
from extradeep.gui.expander_widget import ExpanderWidget
from extradeep.gui.modeler_options_widget import ModelerOptionsWidget
...
from extradeep.modelers.abstract_modeler import AbstractModeler
...
class ModelerWidget(QWidget):
    ...
    def remodel(self):
        ...
        with ProgressWindow(self.main_widget, 'Generating models') as pbar:
            ...
            analysistype = self.main_widget.selector_widget.getSelectedAnalysisType()
