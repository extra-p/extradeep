...
from imdbbenchmark import IMDBBenchmark

parser = argparse.ArgumentParser(description='IMDB Benchmark.')
...
def main():
    ...
    # initialize IMDB benchmark
    benchmark = IMDBBenchmark(REPETITION, NR_PROCESSES, EPOCHS, BATCH_SIZE, TF_PROFILER, VERBOSE, DETERMINISM, MEMORY_GROWTH, MIXED_PRECISION, TENSOR32_EXECUTION)
