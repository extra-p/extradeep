...
class Preprocessor():
    ...
    def __init__(self, trainX, testX, trainY, testY, BATCH_SIZE, PROBLEM_SIZE, EPOCHS, num_workers, worker_index):
        """
    ...
    def encode_labels(self):
        ...
        self.trainY = tf.one_hot(self.trainY, self.PROBLEM_SIZE)
        self.testY = tf.one_hot(self.testY, self.PROBLEM_SIZE)
