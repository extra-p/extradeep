...
from cifar100benchmark import CIFAR100Benchmark

parser = argparse.ArgumentParser(description='CIFAR-100 Benchmark.')
...
parser.add_argument('-mode', dest='mode', action='store',
                    default="nvtx",type=str,choices=["nvtx","all"],
                    help='set profiling mode')
...
def main():
    ...
    benchmark = CIFAR100Benchmark(REPETITION, NR_PROCESSES, NETWORK, EPOCHS, BATCH_SIZE, TF_PROFILER, NR_PARAMETERS, VERBOSE, DETERMINISM, MEMORY_GROWTH, MIXED_PRECISION, TENSOR32_EXECUTION, PROBLEM_SIZE, MODE)
