...
def main():
    ...
    benchmark = CIFAR10Benchmark(REPETITION, NR_PROCESSES, NETWORK, EPOCHS, BATCH_SIZE, TF_PROFILER, NR_PARAMETERS, VERBOSE, DETERMINISM, MEMORY_GROWTH, MIXED_PRECISION, TENSOR32_EXECUTION)
