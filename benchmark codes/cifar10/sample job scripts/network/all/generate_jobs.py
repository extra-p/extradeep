...
for i in range(len(networks)):
    ...
    text += "srun nsys profile -t nvtx,cuda,mpi,cublas,cudnn --mpi-impl openmpi -b none --cpuctxsw none -f true -x true -o cifar10.n"+str(networks[i])+".r1.mpi%q{SLURM_PROCID} python -u main.py -p 4 -n resnet"+str(networks[i])+" -r 1 -nrparameters 2\n"
